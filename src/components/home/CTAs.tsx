          ...
          >
            <div className="relative z-10 flex flex-col items-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center">
                <a href="https://wa.me/917306338989" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center gap-2 bg-black text-white px-6 py-3 rounded-full font-medium hover:bg-gray-900 transition-colors w-full sm:w-auto">
                  WhatsApp Us
                </a>
                <a href="tel:+917306338989" className="inline-flex items-center justify-center gap-2 border border-black/20 text-black px-6 py-3 rounded-full font-medium hover:bg-black/5 transition-colors w-full sm:w-auto">
